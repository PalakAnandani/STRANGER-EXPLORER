...
if(isset($_POST['update']))
{
  ...
  $up_seller = mysqli_query($con,"UPDATE tbl_users SET `name`='$name',`contact`='$contact',`address`='$address',`city`='$city',`username`='$username',`password`='$password' WHERE user_id = '".$hidid."' ");
